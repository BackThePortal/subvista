...
function createWindow() {
    ...
    subInputValue.value = 'Lorem ipsum dolor sit amet';
...
<template>
  ...
  <div class="space-y-4">
    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-4 p-2 flex justify-center">
		  <h1 class="text-5xl text-slate-300 transition hover:text-slate-100">Subvista</h1>
    </div>
	</header>
  <nav>
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-4 p-2">
      <div class="flex flex-wrap gap-2">
        <button v-if="windowVideo" @click="createWindow" class="bg-red-700/60 active:bg-red-700 active:ring-red-500">Tancar finestra</button>
        <button v-else @click="createWindow" class="bg-green-700/60 active:bg-green-700 active:ring-green-500">Crear finestra</button>
        ...
        <button @click="settings.ui.settings = !settings.ui.settings">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-current" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-4 p-2">
      <div class="md:grid md:grid-cols-6">
        ...
        <textarea
            ...
            rows="2"
          class=" rounded-md bg-slate-600 p-2 text-xl text-white shadow-2xl outline-0 ring-slate-300 focus:ring-2 disabled:text-slate-300 w-full"
          ref="subInputArea"
